...
class PlayerPageOriginal extends StatelessWidget {
  const PlayerPageOriginal({super.key});
              ...
              child: Column(
                children: [
                  ListTile(
                    ...
                    title: Text(
                      appStatePlayer.players.elementAt(index).name,
                    ),
                    subtitle: Text(
                      appStatePlayer.players.elementAt(index).position,
                    ),
                    trailing: TextButton(
